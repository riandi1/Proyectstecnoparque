            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="relative">              
                                        <div class="pt-2  mx-auto relative text-gray-600">
                                            <input v-model="search" @keyup="userSearch" type="search" placeholder="Buscar amigos ..." class="bg-white w-full h-10 px-5 pr-10 rounded-full text-sm focus:outline-none">
                                        ...
                                        <a v-if="users.length > 0" v-for="(user,index) in users" :key="index" class="block flex bg-white items-center w-70 py-2 px-3 hover:bg-gray-100">
                                        ...
                                        <div v-if="!userexists" class="py-2 px-3 flex items-center bg-white">
