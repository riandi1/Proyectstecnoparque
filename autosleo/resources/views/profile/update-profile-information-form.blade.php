<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Aca podra actualizar sus Datos de usuario o su correo electronico') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="w-md-100">
            ...
            {{-- <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <x-jet-label value="{{ __('Fecha nacimineto') }}" />
    
                        <x-jet-input class="{{ $errors->has('dateB') ? 'is-invalid' : '' }}" type="date"  wire:model.defer="state.dateB"
                                    :value="old('dateB')" required  autocomplete="dateB" />
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div>
                            ...
                            <select :value="old('municipalityid')" name="municipalityid" class="form-control {{ $errors->has('municipalityid') ? 'is-invalid' : '' }}" wire:model.defer="state.municipalityid" id="select22">
