        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <x-jet-label value="{{ __('Municipio') }}" />
                            <select name="municipalities" class="form-control">
                                <option selected="selected">Seleccione Municipio</option>
                            @foreach ($municipios as $municipio)
                                <option value="{{$municipio->id}}">{{$municipio->name}}</option>
                            @endforeach
                            </select>
                            {{-- <x-jet-input class="{{ $errors->has('municipalities') ? 'is-invalid' : '' }}" type="text" name="municipalities"
                                        :value="old('municipalities')" required autofocus autocomplete="municipalities" />
                            <x-jet-input-error for="municipalities"></x-jet-input-error> --}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{-- <x-jet-input class="{{ $errors->has('gender') ? 'is-invalid' : '' }}" type="text" name="gender"
