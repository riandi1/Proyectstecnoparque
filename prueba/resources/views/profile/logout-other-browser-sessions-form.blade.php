<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Administre y cierre la sesión activa en otros navegadores y dispositivos.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="d-flex mt-3">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar sesión en otras sesiones del explorador') }}
            </x-jet-button>
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Introduzca su contraseña para confirmar que desea cerrar la sesión de las demás sesiones del navegador en todos sus dispositivos.') }}
