...
option = null, option = {
  ...
  color: ["#34c38f"]
}, option && "object" == (typeof option === "undefined" ? "undefined" : _typeof(option)) && myChart.setOption(option, !0);
...
dom = document.getElementById("doughnut-chart"), myChart = echarts.init(dom), app = {};
option = null, option = {
  tooltip: {
    trigger: "item",
...
dom = document.getElementById("pie-chart"), myChart = echarts.init(dom), app = {};
option = null, option = {
  tooltip: {
    trigger: "item",
    formatter: "{a} <br/>{b} : {c} ({d}%)"
...
dom = document.getElementById("scatter-chart"), myChart = echarts.init(dom), app = {};
option = null, option = {
  grid: {
    zlevel: 0,
    x: 50,
...
dom = document.getElementById("bubble-chart"), myChart = echarts.init(dom), app = {};
option = null;
...
option = {
  ...
  series: [{
    ...
    data: data[0],
    type: "scatter",
    symbolSize: function symbolSize(e) {
...
dom = document.getElementById("candlestick-chart"), myChart = echarts.init(dom), app = {};
option = null, option = {
  grid: {
    zlevel: 0,
    x: 50,
...
option = null, option = {
  ...
  series: [{
    ...
    axisLine: {
      lineStyle: {
        color: [[.2, "#34c38f"], [.8, "#556ee6"], [1, "#f46a6a"]],
        width: 20
      }
    },
    data: [{
...
}, 2e3), option && "object" == (typeof option === "undefined" ? "undefined" : _typeof(option)) && myChart.setOption(option, !0);
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\vertical\vertical\resources\js\pages\echarts.init.js */"./resources/js/pages/echarts.init.js");
