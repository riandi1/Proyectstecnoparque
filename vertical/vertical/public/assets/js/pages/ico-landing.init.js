...
}), $(".navbar-nav a").on("click", function (s) {
  var i = $(this);
  $("html, body").stop().animate({
    scrollTop: +$(i.attr("href")).offset().top
  }, 1500, "easeInOutExpo"), s.preventDefault();
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\vertical\vertical\resources\js\pages\ico-landing.init.js */"./resources/js/pages/ico-landing.init.js");
