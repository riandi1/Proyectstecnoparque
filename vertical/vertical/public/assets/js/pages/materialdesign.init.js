...
function getIconItem(e, n) {
  ...
  return i.appendChild(document.createTextNode("mdi-" + e.name)), o.appendChild(i), o;
}
...
!function () {
  ...
  e.push({
    ...
    if (document.getElementById("icons").appendChild(n), isNew(e)) {
      var o = getIconItem(e, !1, !1);
      document.getElementById("newIcons").appendChild(o), 0;
    }
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\vertical\vertical\resources\js\pages\materialdesign.init.js */"./resources/js/pages/materialdesign.init.js");
