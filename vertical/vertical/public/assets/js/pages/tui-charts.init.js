...
container = document.getElementById("column-charts"), data = {
...
container = document.getElementById("line-charts"), data = {
...
container = document.getElementById("area-charts"), data = {
...
container = document.getElementById("radial-charts"), data = {
...
container = document.getElementById("bubble-charts"), data = {
  series: [{
    name: "Africa",
    data: [{
      x: 4200,
  ...
  chart: {
    ...
    format: function format(e, a, t, r) {
      return "r" !== r && "x" !== r || (e = tui.chart.renderUtil.formatToComma(e), "x" === r && (e = "$" + e)), e;
    }
  },
  yAxis: {
  ...
  tooltip: {
    template: function template(e, a) {
      return '<div class="tui-chart-default-tooltip"><div class="tui-chart-tooltip-head"><span class="tui-chart-legend-rect" style="' + a.cssText + '; width: 10px; height: 10px"></span><span>' + a.legend + "</span><span>" + a.label + '</span></div><table class="tui-chart-tooltip-body"><tr><td>GDP</td><td class="tui-chart-tooltip-value">' + a.x + '</td></tr><tr><td>Life Expectancy</td><td class="tui-chart-tooltip-value">' + a.y + '</td></tr><tr><td>Population</td><td class="tui-chart-tooltip-value">' + a.r + "</td></tr></table>";
    }
  }
}, theme = {
  chart: {
...
container = document.getElementById("scatter-charts"), data = {
  series: [{
    name: "male",
    data: [{
      x: 174,
  ...
  tooltip: {
    template: function template(e, a) {
      return '<div class="tui-chart-default-tooltip"><div class="tui-chart-tooltip-head">' + a.legend + '</div><table class="tui-chart-tooltip-body"><tr><td>Weight</td><td class="tui-chart-tooltip-value">' + a.x + 'kg</td></tr><tr><td>Height</td><td class="tui-chart-tooltip-value">' + a.y + "cm</td></tr></table></div>";
    }
  }
}, theme = {
  chart: {
...
container = document.getElementById("pie-charts"), data = {
  categories: ["Browser"],
  series: [{
    name: "Chrome",
    data: 46.02
...
container = document.getElementById("donut-charts"), data = {
  categories: ["Browser"],
  series: [{
    name: "Chrome",
    data: 46.02
  ...
  chart: {
    ...
    height: 380,
    title: "Usage share of web browsers",
    format: function format(e, a, t, r, o) {
...
$(window).resize(function () {
  donutpieChartWidth = $("#donut-charts").width(), donutpieChart.resize({
    width: width,
    height: 350
  });
});
var heatmapchartsWidth = $("#heatmap-charts").width();
container = document.getElementById("heatmap-charts"), data = {
  categories: {
...
$(window).resize(function () {
  heatmapChartChartWidth = $("#heatmap-charts").width(), heatmapChartChart.resize({
    width: width,
    height: 350
  });
});
var treemapchartsWidth = $("#treemap-charts").width();
container = document.getElementById("treemap-charts"), data = {
  series: [{
    label: "Documents",
    children: [{
      label: "docs",
...
$(window).resize(function () {
  treemapChartChartWidth = $("#treemap-charts").width(), treemapChartChart.resize({
    width: width,
    height: 350
  });
});
var mapchartsWidth = $("#map-charts").width();
container = document.getElementById("map-charts"), data = {
  series: [{
    code: "US-AK",
    data: -3
  }, {
...
$(window).resize(function () {
  mapChartChartWidth = $("#map-charts").width(), mapChartChart.resize({
    width: width,
    height: 350
  });
});
var boxplotchartsWidth = $("#boxplot-charts").width();
container = document.getElementById("boxplot-charts"), data = {
...
container = document.getElementById("bullet-charts"), data = {
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\vertical\vertical\resources\js\pages\tui-charts.init.js */"./resources/js/pages/tui-charts.init.js");
