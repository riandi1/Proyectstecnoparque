...
$password_r = "";
$msg = "";
//se verifica que el usuario lleno todos los campos de registro
if( isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password_r'])) {

  $email = strip_tags($_POST['email']);
  $password = strip_tags($_POST['password']);
  $password_r = strip_tags($_POST['password_r']);  //variable de verificacion de password ingresado

  //verifica si los dos passwords ingresados coinciden
  if ($password==$password_r){
    ...
    if ($count == 0){
      ...
      $conn->query("INSERT INTO `users` (`users_email`, `users_password`) VALUES ('".$email."', '".$password."');"); //guardar usuario en la DB
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form method="post" target="register.php" name="form">
        <div class="md-form-group">
          <input name="email" type="email" class="md-input" value="<?php echo $email; ?>" required> <!-- repoblar formulario -->
          <label>Email</label>
        </div>
        <div class="md-form-group">
